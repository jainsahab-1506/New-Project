  ...
  // }
    return (
        ...
        <div class="container">
          ...
          <hr />
          <Link class="buttonmain btn btn-dark btn-lg" to="/login" role="button">Login</Link>
          <Link class="buttonmain btn btn-dark btn-lg" to="/register" role="button">Register</Link>
        </div>
        </div> 
